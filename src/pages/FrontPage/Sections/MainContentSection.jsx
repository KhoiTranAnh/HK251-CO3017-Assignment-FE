...
export const MainContentSection = ({ handleSignUpButtonClick }) => {
    return (
        <section className="flex grow-0 shrink-0 w-full h-[500px] items-center justify-center gap-[30px] relative bg-[linear-gradient(161deg,rgba(40,97,234,1)_0%,rgba(126,34,206,1)_100%)]">
            <div className="flex flex-col w-[500px] items-start gap-[30px] p-2.5 relative">
                ...
                <Button onClick={handleSignUpButtonClick} label='Tạo tài khoản để bắt đầu' variant='primary' />
            </div>
